...
def test_nemenyi():
    data = np.asarray([(88, 74, 90, 90),       #1
                       (99, 94, 95, 95),       #2
                       (18, 14, 10, 10)])      #3
    print(friedmanchisquare(data[0], data[1], data[2]))
...
class NemenyiTestPostHoc():
    ...
    def do(self):
        ...
        qValues = self._compareStatisticsOfAllPairs(meansOfRanksOfDependentSamples) #3 element vector
