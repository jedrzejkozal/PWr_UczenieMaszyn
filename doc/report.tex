...
Very low p-value was reported for LDA and PCA, and this is in line with obtained difference in average ranks that equal to 0.875.


\section{Conclusions}

Experiments were carried out with established methodology. Results were collected and analysed. Some flaws in chosen methodology were pointed out and considered during analysis of results.
