...
\begin{figure*}
    \centering
    \includegraphics[scale=0.8]{images/Svm_accuracy_comparison.png}
...
\begin{figure*}
    \centering
    \includegraphics[scale=0.8]{images/Svm_fit_time_comparison.png}
...
\begin{table*}
    \centering
    \caption{Comparison of p-values and F-values for ANOVA test for Svc classifier}
