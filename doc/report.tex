...
Experiments were carried out with established methodology. Results were collected and analysed. Some flaws in chosen methodology were pointed out and taken into consideration during the analysis of results.

For both SVC and MLP classifiers performance obtained by CNN was better then performance of PCA and LDA. No statistical difference was noted between LDA and PCA. Besides that, PCA in usage with SVC had some problems with few databases, especially with datasets containing different face orientations (f.e.. att, georgia, muct or stirling).

Time of the training was reported in this article, but only for illustrative purposes. No statistical analysis of training time was performed.
